						...
						<Card.Body>
							<div className="d-flex flex-column">
								...
								<div className="d-flex flex-row mb-2">
									<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-house"
									 viewBox="0 0 16 16">
										<path
										d="M8.707 1.5a1 1 0 0 0-1.414 0L.646 8.146a.5.5 0 0 0 .708.708L2 8.207V13.5A1.5 1.5 0 0 0 3.5 15h9a1.5 1.5 0 0 0 1.5-1.5V8.207l.646.647a.5.5 0 0 0 .708-.708L13 5.793V2.5a.5.5 0 0 0-.5-.5h-1a.5.5 0 0 0-.5.5v1.293L8.707 1.5ZM13 7.207V13.5a.5.5 0 0 1-.5.5h-9a.5.5 0 0 1-.5-.5V7.207l5-5 5 5Z"/>
									</svg>
									<p className={styles.footer_contact_text}>Adresse:<a target="_blank" href="https://goo.gl/maps/SfWkxnTKU4PFnHZu8">Walsroder Straße, 3 Eickeloh, 29693</a></p>
								</div>
								<div className="d-flex flex-row mb-2">
								...
								<div className="d-flex flex-row">
									...
									<p className={styles.footer_contact_text}>
										E-mail:<a href="mailto: Imkerverein-Ahlden@t-online.de">Imkerverein-Ahlden@t-online.de</a>
									</p>
								</div>
							</div>
						</Card.Body>
						...
						<Card.Body>
							<div>
								...
								<div>
									<p className={styles.footer_data}>April 27, 2023</p>
									<p className={styles.footer_name_event}>
										<a href="/"> BEEKEEPER – BEES AND BEEKEEPING BEES AND BEEKEEPING</a>
									</p>
									<hr />
								</div>
								<div>
...
{/*About*/}
				...
				<Container>
					<div className={styles.social}>
						<svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="#f7f3f0"
